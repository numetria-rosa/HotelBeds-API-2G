...
var validator = (function($){
    ...
    */
    message = {
        ...
        min             : 'entrée est courte',
        max             : 'entrée est longue',
        number_min      : 'too low',
        number_max      : 'too high',
        url             : 'invalide URL',
        number          : 'ce n\'est pas un nombre',
        email           : 'adresse email invalide',
        email_repeat    : 'les adresse email ne correspondent pas',
        password_repeat : 'les mots de passe ne correspondent pas',
        repeat          : 'aucune correspondance',
        complete        : 'votre entrée n\'est pas complète',
