...
$AGN = $site->SelectFromTableORD($table,$ord,$dir);
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="btn btn-sm btn-default" href="<?php echo $WORKPATH;?>agence_add.php"><i class="fa fa-plus"></i> Ajouter</a>
                      </li>
                    </ul>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered ">
                      ...
                      <tbody>
                        ...
                        foreach ($AGN as $agn) {
                          ...
                          if($agn_etat == 0){
                            $ETAT = '<a class="btn btn-danger btn-sm agn_activ" p="'.$agn_pid.'" e="'.$agn_etat.'"> Désactivé </a>';
                          }else{
                            $ETAT = '<a class="btn btn-success btn-sm agn_activ" p="'.$agn_pid.'" e="'.$agn_etat.'"> Activé </a>';
                          }
                        ...
                        <tr id="agn_activ<?php echo $agn_pid;?>">
                          ...
                          <td><?php echo DD($agn_creation);?></td>
