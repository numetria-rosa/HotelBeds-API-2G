...
<html lang="fr">
  ...
  <body class="nav-md">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo $WORKPATH;?>files/functions_confirm.php" novalidate autocomplete="off">
                      ...
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="canal" type="text" name="canal" placeholder="" class="form-control col-md-7 col-xs-12" required="required">
                              <option <?php if($canal=='B2E'){?> selected <?php }?> value="B2E">B2E</option>
                              <option <?php if($canal=='B2B'){?> selected <?php }?> value="B2B">B2B</option>
                          </select>
                        </div>
                      </div>
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="agn_rc" value="<?php echo $agn_rc;?>" type="text" name="agn_rc" placeholder="N° Registre de Commerce" data-validate-length="3,4" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="agn_iata" value="<?php echo $agn_iata;?>" type="text" name="agn_iata" placeholder="N° IATA" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="agn_zipcode" value="<?php echo $agn_zipcode;?>" type="text" name="agn_zipcode" placeholder="Code Postal" class="form-control col-md-7 col-xs-12" required="required">
                        </div>
                      </div>
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="agn_mf" value="<?php echo $agn_mf;?>" type="text" name="agn_mf" placeholder="N° Matricule Fiscale" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="clearfix"></div>
                      ...
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="agn_licence" value="<?php echo $agn_licence;?>" type="text" name="agn_licence" placeholder="Licence" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="agn_markup" value="<?php echo $agn_markup;?>" type="text" name="agn_markup" placeholder="MARKUP" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="item form-group col-md-9 col-sm-12 col-xs-12">
                        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="roles">Rôles<span class="required">*</span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select id="roles" name="roles[]" class="selectpicker form-control" multiple required>
                            <option value="1"<?php if($rolesAgn[0]==1){?> selected<?php }?>>H&ocirc;tels en Tunisie</option>
                            <option value="2"<?php if($rolesAgn[1]==2){?> selected<?php }?>>H&ocirc;tels Hotelbeds</option>
                          </select>
                        </div>
                      </div>
                        ...
                        <div class="col-md-55">
                          <div class="thumbnail">
                            <div class="image view view-first">
                              <img style="width: 100%; display: block;" src="<?php echo $WORKPATH;?>images/logo/<?php echo $logo;?>" />
                              <div class="mask">
                                <div class="tools tools-bottom">
                                  <a class="HotelImageRemove" p="<?php echo  $agn_pid ;?>"><i class="fa fa-times"></i></a>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="item form-group col-md-12 col-sm-12 col-xs-12">
                        ...
                        <label for="HotelImages" class="control-label">Logo<span class="required">*</span></label>
                          <div class="image_upload_div" style="">
    ...
    <script>
      ...
      $(".HotelImageRemove").click(function (e) {
        var id =$(this).attr('p');
    
            var dataString = 'iduser=' + id  + '&action=removeFile';
            $.ajax({
                type: "POST",
                url:"/admin/logoUpload.php",
                data: dataString,
                cache: false,
