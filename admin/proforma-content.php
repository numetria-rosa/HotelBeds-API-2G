...
<page backcolor="#FEFEFE"  backimgx="center" backimgy="bottom" backimgw="100%" backtop="0" backbottom="0" style="font-size: 12px">
    ...
    <table cellspacing="0" style="width: 100%; text-align: center; font-size: 16pt; margin-top: 20px;">
        <tr>
            <th style="width:100%; background: #ffffff; border: #ffffff !important; color: #000000;">Proforma N&deg; '.$BOOK_REF.'</th>
        </tr>
    </table>
    <table cellspacing="0" cellpadding="0" style="width: 100%; text-align: left; font-size: 12px; margin-top: 20px; border: 1px thin #cd015a; background-color: #cd015a;">
        <tr>
            <th style="width:100%; padding: 8px 15px; border-bottom: 1px thin #cd015a; border: 1px thin #cd015a; background-color: #cd015a;">D&Eacute;TAILS DE VOTRE R&Eacute;SERVATION</th>
        </tr>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" style="width: 100%; text-align: left; font-size: 12px; margin-top: 20px;">
        ...
        <tr>
            ...
            <td style="width:70%; text-align:left; font-weight:bold; padding-left:5px;">DMC Booking</td>
        </tr>
        
        <tr>
            <td style="width:30%; text-align:right; padding-right:5px;">Client Principal</td>
            <td style="width:70%; text-align:left; padding-left:5px; font-weight:bold;">'.$BOOK_LT.' '.$BOOK_LFN.' '.$BOOK_LLN.'</td>
        </tr>
    </table>
    ...
    <table cellspacing="0" style="width: 100%; text-align: center; font-size: 11pt; ">
        <tr>
            ...
            <th style="width:100%; background-color: #cd015a; border-color: #cd015a;">Prix Client</th>
            
        </tr>
        <tr>
            <td>'.$BOOK_PRIX_CLIENT.' '.$AGN_CODE.'</td>
        </tr>
    </table>
