                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo $WORKPATH;?>files/functions_confirm.php" novalidate autocomplete="off">
                      ...
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="agn_markup" value="" type="text" name="agn_markup" placeholder="MARKUP" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					            <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="item form-group col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select id="roles" name="roles[]" class="selectpicker form-control" multiple required>
                            ...
                            <option value="10">H&ocirc;tels Hotelbeds</option>
                            <option value="3">Transferts</option>
                      ...
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="client_prenom" value="" class="form-control col-md-7 col-xs-12" data-validate-length-range="3" data-validate-words="1" name="client_prenom" placeholder="Prénom" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group col-md-6 col-sm-12 col-xs-12">
