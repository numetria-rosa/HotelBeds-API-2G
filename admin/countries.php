                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <?php /*<li><a class="btn btn-sm btn-default" href="<?php echo $WORKPATH;?>countries/new/"><i class="fa fa-plus"></i> Ajouter</a></li>*/?>
                    </ul>
                  ...
                  <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered table-buttons">
                      ...
                      <tbody>
                        ...
                        ?>
                        <tr>
                          <td><?php echo $PaysNom;?></td>
                          <td>
                            <a class="btn btn-info btn-sm" href="<?php echo $WORKPATH;?>country.php?pid=<?php echo $PaysPid;?>"> Modifier </a>
                            <a class="btn btn-danger btn-sm country_del" p="<?php echo $PaysPid;?>/"> Supprimer </a>
                          </td>
                        </tr>
                        <?php
                        }
