...
$AGN = $site->SelectFromTableWC($table,'canal','B2E',$ord,$dir);
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="btn btn-sm btn-default" href="<?php echo $WORKPATH;?>agence_add_b2e.php"><i class="fa fa-plus"></i> Ajouter</a>
                      </li>
                    </ul>
